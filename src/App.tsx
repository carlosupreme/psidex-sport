            ...
            Convenios Deportivos
                ...
                <svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 300 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2 9C50 3 150 1 298 9" stroke="#055c9d" strokeWidth="3" strokeLinecap="round" opacity="0.4" />
                        ...
                        <p className="mx-auto mb-6 max-w-2xl text-lg leading-relaxed text-[#706f6c] dark:text-[#A1A09A]">
                            En Psidex creemos que el rendimiento colectivo empieza desde adentro.
                            Invitamos a clubes, academias y equipos deportivos a formar convenios con nosotros
                            para integrar el entrenamiento mental como parte fundamental de su programa.
                        </p>

                        <p className="mx-auto mb-10 max-w-2xl text-base text-[#706f6c] dark:text-[#A1A09A]">
                            Juntos diseñamos un plan a la medida de su disciplina, etapa competitiva y objetivos,
                        ...
                        <a href="https://wa.me/5219511899817?text=Hola,%20me%20gustaría%20información%20sobre%20convenios%20para%20mi%20equipo%20deportivo"
                           target="_blank"
                           rel="noopener noreferrer"
                           className="group inline-flex items-center gap-3 rounded-sm bg-[#055c9d] px-8 py-4 text-base font-semibold text-white shadow-lg shadow-[#055c9d]/30 transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#044a7d] hover:shadow-xl hover:shadow-[#055c9d]/40"
                        >
